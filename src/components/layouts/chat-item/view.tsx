        ...
        <div className="flex w-full min-w-0 flex-col gap-y-0.5">
            ...
            <div className="flex items-center justify-between">
                <div className="flex min-w-0 items-center gap-x-2">
                    ...
                    <p
                        className={cn(
                            ...
                            (conversation.lastMessage.isDeleted || conversation.lastMessage.messageType === 'AUDIO' || conversation.lastMessage.messageType === 'FILE') && 'italic'
                        )}
                    >
                ...
                {conversation.unreadMessageCount > 0 && (
                    <Badge className="rounded-full px-1.5 py-0 text-[11px] leading-4">
