...
const MainLayoutView: FC<MainLayoutViewProps> = ({
    ...
    conversationVirtualItems,
    conversationVirtualMeasureElement,
    conversationVirtualTotalSize,
                                    ...
                                    <>
                                        {privateConversations && privateConversations.length === 0 ? (
                                            ...
                                            <div
                                                ...
                                                style={{
                                                    height: conversationVirtualTotalSize,
                                                }}
                                            >
                                                {conversationVirtualItems.map((virtualRow) => {
                                                    const conversation =
                                                        privateConversations?.[
                                                            virtualRow.index
                                                        ];
                                        ...
                                        {isFetchingNextPrivateConversationsPage && (
                                            <div className="pointer-events-none sticky bottom-2">
