    ...
    <div className="relative z-20 shrink-0 border-t border-border/70 bg-background/85 backdrop-blur">
        ...
        >
            <Button
                ...
                variant='ghost'
                size='icon-sm'
                className="rounded-lg border border-transparent hover:border-border/70 hover:bg-white"
            >
                <IconPlus className="size-5 text-muted-foreground" />
            </Button>
            <div className="flex flex-1 rounded-xl border border-border/70 bg-white px-1 shadow-[0_20px_26px_-30px_oklch(0.28_0.04_250)]">
                <TfTextInput
                    form={form}
